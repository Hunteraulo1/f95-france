...
--
-- L’application accède à Postgres via la connexion serveur (rôle propriétaire / service_role),
...
REVOKE ALL PRIVILEGES ON TABLE public.passkey
FROM anon, authenticated;

REVOKE ALL PRIVILEGES ON TABLE public.passkey_challenge
FROM anon, authenticated;
