...
-- api_key
DROP POLICY IF EXISTS deny_all_api_key ON public.api_key;

CREATE POLICY deny_all_api_key ON public.api_key FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);

-- api_key_rate
DROP POLICY IF EXISTS deny_all_api_key_rate ON public.api_key_rate;

CREATE POLICY deny_all_api_key_rate ON public.api_key_rate FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_api_log ON public.api_log FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_config ON public.config FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_game ON public.game FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_game_translation ON public.game_translation FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_notification ON public.notification FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_passkey ON public.passkey FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_passkey_challenge ON public.passkey_challenge FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_session ON public.session FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_submission ON public.submission FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
...
CREATE POLICY deny_all_translator ON public.translator FOR ALL TO anon,
authenticated USING (false)
WITH
    CHECK (false);
